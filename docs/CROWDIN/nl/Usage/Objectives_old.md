...
- Enable [temp targets](../Usage/temptarget.md) if necessary. Utilisez des cibles temp. Utilisez des cibles temp. Utilisez des cibles temp. hypo temp pour éviter que le système ne corrige trop fortement une augmentation de la glycémie après une hypo. Utilisez des cibles temp. Utilisez des cibles temp. hypo temp pour éviter que le système ne corrige trop fortement une augmentation de la glycémie après une hypo.
