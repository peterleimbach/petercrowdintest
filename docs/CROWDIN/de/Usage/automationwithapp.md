...
* secret : votre hachage SHA1 de l'API. Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Vouc pouvez convertir votre clé API au format SHA1 sur <http://www.sha1-online.com/> Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Vouc pouvez convertir votre clé API au format SHA1 sur <http://www.sha1-online.com/> Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Vouc pouvez convertir votre clé API au format SHA1 sur <http://www.sha1-online.com/> Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Ce n'est PAS votre clé api ! Vouc pouvez convertir votre clé API au format SHA1 sur <http://www.sha1-online.com/>
